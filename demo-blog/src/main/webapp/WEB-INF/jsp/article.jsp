		...
		<div class="content">
			...
			<div class="article-meta">
				<span class="item article-meta-time"> <time class="time"
					...
					<i class="glyphicon glyphicon-time"></i> <fmt:formatDate
						value="${article.createtime }" pattern="yyyy-MM-dd HH:mm:ss" /></time>
				...
				<span class="item article-meta-views" data-toggle="tooltip"
					...
					class="glyphicon glyphicon-eye-open"></i> 共${article.readcnt }次阅读</span> <span
			...
			<div id="postcomments">
				<c:forEach items="${article.comments }" var="c" varStatus="vs">
					<ol class="commentlist">
						...
						<span class="comment-f">#${vs.index +1 }</span>
							<div class="comment-avatar">
								<img class="avatar" src="images/icon/icon.png" alt="" />
							</div>
							<div class="comment-main">
								<p>
									来自<span class="address">河南郑州</span>的用户<span class="time">(<fmt:formatDate
											value="${c.createtime }" pattern="yyyy-MM-dd HH:mm:ss" />)
									</span><br /> ${c.content }
								</p>
							</div></li>
					</ol>
